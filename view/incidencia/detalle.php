                                ...
                                <div class="d-flex align-items-center gap-3 ms-auto">
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <span class="badge px-3 py-2 fw-semibold 
                                            <?php
                                            echo ($info['estado_incidencia'] == 'Pendiente') ? 'border border-warning text-warning bg-white' : (($info['estado_incidencia'] == 'Resuelto') ? 'border border-success text-success bg-white' :
                        ...
                        <form id="form_editar_incidencia">
                            ...
                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="tipo_incidencia" id="tipo_incidencia" class="form-select">
                                                        ...
                                                        <option value="Funcional"
                                                            <?= $info["tipo_incidencia"] == "Funcional" ? "selected" : ""; ?>>
                                                            Funcional</option>
                                                        <option value="Documentacion"
                                                            <?= $info["tipo_incidencia"] == "Documentacion" ? "selected" : ""; ?>>
                                                            Documentacion</option>
                                                        <option value="Validación"
                                                            <?= $info["tipo_incidencia"] == "Validación" ? "selected" : ""; ?>>
                                                            Validación</option>
                                                        <option value="Integración"
                                                            <?= $info["tipo_incidencia"] == "Integración" ? "selected" : ""; ?>>
                                                            Integración</option>
                                                        <option value="Base de Datos"
                                                            <?= $info["tipo_incidencia"] == "Base de Datos" ? "selected" : ""; ?>>
                                                            Base de Datos</option>
                                                        <option value="Otro"
                                                            <?= $info["tipo_incidencia"] == "Otro" ? "selected" : ""; ?>>
                                                            Otro</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <select name="prioridad" id="prioridad" class="form-select">
                                                        <option value="Alta"
                                                            <?= $info["prioridad"] == "Alta" ? "selected" : ""; ?>>Alta
                                                        </option>
                                                        <option value="Media"
                                                            <?= $info["prioridad"] == "Media" ? "selected" : ""; ?>>Media
                                                        </option>
                                                        <option value="Baja"
                                                            <?= $info["prioridad"] == "Baja" ? "selected" : ""; ?>>Baja
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="input-group mb-2">
                                                ...
                                                <button type="button" id="btn_subir_imagen" class="btn btn-success"
                                            ...
                                            <small class="text-muted">Selecciona una o varias imágenes y haz clic en el
                                                botón para subirlas a la galería.</small>
                                ...
                                <div class="col-lg-4">
                                            ...
                                            <div class="mt-3">
                                                ...
                                                <select id="estado_incidencia" name="estado_incidencia" class="form-select">
                                                    ...
                                                    <option value="En Proceso"
                                                        <?= $info["estado_incidencia"] == "En Proceso" ? "selected" : ""; ?>>
                                                        En Proceso</option>
                                                    <option value="Resuelto"
                                                        <?= $info["estado_incidencia"] == "Resuelto" ? "selected" : ""; ?>>
                                                        Resuelto
                                                    </option>
                                                    <option value="Cerrado"
                                                        <?= $info["estado_incidencia"] == "Cerrado" ? "selected" : ""; ?>>
                                                        Cerrado
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <!-- 🔥 Seguimiento de la incidencia AHORA DENTRO DE LA COLUMNA -->
                                    <div class="card mb-3">
