            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <div class="card mb-3 border-0 shadow-sm" style="background: #f8f9fc;">
                        <div class="card-body d-flex justify-content-between align-items-center flex-wrap gap-3 border-start border-4 border-primary rounded-3">
                    ...
                    <form id="form_editar_incidencia">
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="descripcion" id="descripcion" class="form-control" rows="3"><?= htmlspecialchars($info["descripcion"]); ?></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Acción recomendada / correctiva</label>
                                            <textarea name="accion_recomendada" id="accion_recomendada" class="form-control" rows="3"><?= htmlspecialchars($info["accion_recomendada"]); ?></textarea>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select name="tipo_incidencia" id="tipo_incidencia" class="form-select">
                                                    ...
                                                    <option value="Integración" <?= $info["tipo_incidencia"] == "Integración" ? "selected" : ""; ?>>Integración</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="base_datos" id="base_datos" class="form-control" value="<?= htmlspecialchars($info["base_datos"]); ?>">
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label fw-semibold">Versión del sistema</label>
                                            <input type="text" name="version_origen" id="version_origen" class="form-control" value="<?= htmlspecialchars($info["version_origen"]); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-4">
                                <div class="card mb-3">
                                    <div class="card-header fw-semibold">Información de Registro</div>
                                    <div class="card-body">
                                        <p><strong>Analista QA:</strong><br><?= htmlspecialchars($info["analista"]); ?></p>
                                        <p><strong>Fecha de Registro:</strong><br><?= htmlspecialchars($info["fecha_registro"]); ?></p>
                                        <p><strong>Fecha de Recepción:</strong><br><?= htmlspecialchars($info["fecha_recepcion"]); ?></p>
                                    </div>
                                </div>
                            </div>
                        </div>
