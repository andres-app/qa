...
$rol = new Rol();
$datos = $rol->validar_menu_x_rol($_SESSION["rol_id"], "documentacion");
...
if (isset($_SESSION["usu_id"]) && count($datos) > 0) {
    ...
    <body>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Gestión de Documentación</h4>
                                    ...
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <div>
                                            ...
                                            <p class="card-title-desc">
                                                Vista para registrar, modificar, listar y eliminar documentación del
                                                sistema.
                                            </p>
                                        </div>
        ...
        <?php require_once("documentacion_modal.php"); ?>
