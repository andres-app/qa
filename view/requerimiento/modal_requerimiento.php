    ...
    <form method="post" id="mnt_form">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <!-- 🟦 Fila 4: Asociación de Especialidades y Órganos -->
          <div class="row">
            <div class="col-md-6 mb-3">
            ...
            <div class="col-md-6 mb-3">
              <label for="organos" class="form-label">Órganos Jurisdiccionales Asociados</label>
              <select class="form-control" id="organos" name="organos[]" multiple>
                <!-- Se carga dinámicamente vía AJAX -->
              </select>
              <small class="text-muted">Puede seleccionar uno o varios órganos jurisdiccionales</small>
            </div>
          </div>
